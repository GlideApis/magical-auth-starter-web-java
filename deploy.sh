...
# Variables
SERVICE_NAME="magical-auth-starter-java"
...
${BASH_BLUE}██████${BASH_BOLD_WHITE}███${BASH_BLUE}██${BASH_BOLD_WHITE}███${BASH_BLUE}██████${BASH_NC}   Magical Auth Demo (Java)
